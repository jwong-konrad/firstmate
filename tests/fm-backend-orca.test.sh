...
run_case test_capture_reads_terminal_tail_json
run_case test_capture_falls_back_to_text_fields
run_case test_capture_fails_on_orca_error_json
run_case test_runtime_check_accepts_ready_orca_status
run_case test_runtime_check_refuses_unready_orca_status
run_case test_send_text_submit_verifies_empty_composer_after_enter
run_case test_send_text_submit_keeps_current_tail_when_limited
run_case test_send_text_submit_retries_when_composer_stays_pending
run_case test_composer_state_popup_placeholder_fill_is_pending
run_case test_composer_state_bare_shell_prompt_is_unknown
run_case test_send_text_submit_popup_autocomplete_requires_second_enter
run_case test_send_literal_constructs_non_enter_send
run_case test_send_text_submit_reports_send_failed
run_case test_send_helpers_reject_orca_error_json
run_case test_send_key_enter_and_interrupt
run_case test_send_key_refuses_unknown_key
run_case test_send_key_refuses_escape_until_supported
run_case test_kill_is_best_effort_close
run_case test_remove_worktree_refuses_empty_id
run_case test_remove_worktree_rejects_orca_error_json
run_case test_worktree_path_resolves_id
run_case test_dispatcher_sources_orca_and_routes_primitives
run_case test_json_get_ignores_undocumented_terminal_id_shapes
run_case test_worktree_and_terminal_helpers_parse_json
run_case test_worktree_create_removes_worktree_when_path_missing
run_case test_spawn_preserves_orca_metadata_when_pathless_worktree_cleanup_fails
run_case test_spawn_writes_orca_metadata_and_launches_harness
run_case test_spawn_refuses_orca_secondmate_before_home_mutation
run_case test_spawn_refuses_orca_when_runtime_not_ready
run_case test_spawn_refuses_orca_nonisolated_worktree
run_case test_spawn_removes_orca_worktree_when_terminal_create_fails
run_case test_spawn_preserves_orca_metadata_when_abort_cleanup_fails
run_case test_spawn_releases_orca_resources_when_metadata_write_fails
run_case test_peek_send_and_crew_state_route_through_orca_meta
run_case test_peek_and_crew_state_fail_closed_on_orca_error_json
run_case test_target_exists_rejects_orca_error_json
run_case test_scout_teardown_removes_orca_worktree_via_helper
run_case test_scout_teardown_refuses_orca_id_path_mismatch
run_case test_teardown_removes_orca_worktree_when_path_missing
run_case test_teardown_preserves_metadata_when_orca_remove_error_json
run_case test_scout_teardown_refuses_orca_missing_report_when_path_missing
run_case test_ship_teardown_refuses_orca_missing_worktree_path
run_case test_ship_teardown_removes_orca_worktree_when_id_path_matches
run_case test_ship_teardown_refuses_orca_unresolvable_worktree_id
run_case test_ship_teardown_refuses_orca_id_path_mismatch
run_case test_teardown_refuses_orca_missing_worktree_id
run_case test_teardown_removes_orca_worktree_without_terminal_handle
run_case test_secondmate_force_teardown_removes_orca_child_via_orca
run_case test_secondmate_force_teardown_refuses_orca_child_id_path_mismatch
run_case test_secondmate_force_teardown_removes_partial_orca_child
fm_case_summary "fm-backend-orca"
