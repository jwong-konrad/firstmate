...
install_guard_scripts() {
  ...
  cp "$ROOT/bin/fm-banner-lib.sh" "$dir/bin/fm-banner-lib.sh"
...
run_case test_predicate_healthy_no_inflight
run_case test_predicate_unhealthy_no_beacon
run_case test_predicate_unhealthy_stale_beacon
run_case test_predicate_healthy_fresh_beacon
run_case test_predicate_queue_pending_flag
run_case test_predicate_parked_fleet_is_not_unhealthy
run_case test_predicate_one_progressing_task_is_unhealthy
run_case test_hook_silent_when_no_work_in_flight
run_case test_hook_silent_for_a_deliberately_parked_fleet
run_case test_hook_blocks_when_one_parked_fleet_task_progresses
run_case test_hook_blocks_when_a_parked_task_resumes
run_case test_hook_blocks_when_fresh_beacon_has_no_live_lock
run_case test_hook_blocks_when_dead_lock_has_fresh_beacon
run_case test_hook_silent_with_live_lock_and_fresh_beacon
run_case test_hook_blocks_with_live_lock_and_stale_beacon
run_case test_hook_blocks_when_unhealthy_in_primary
run_case test_hook_blocks_from_fm_home_state
run_case test_hook_x_mode_reason_sources_cadence
run_case test_hook_ignores_repo_state_when_fm_home_set
run_case test_hook_uses_state_override
run_case test_hook_loop_guard_allows_retry
run_case test_hook_blocks_in_secondmate_own_home
run_case test_hook_silent_in_idle_secondmate_home
run_case test_hook_secondmate_loop_guard_allows_retry
run_case test_hook_secondmate_reinvoke_recovery_loop
run_case test_hook_silent_in_secondmate_child_worktree
run_case test_hook_blocks_in_treehouse_leased_secondmate_home
run_case test_hook_exempts_linked_worktree_with_stray_marker
run_case test_hook_exempts_linked_worktree_with_non_ascii_marker
run_case test_hook_silent_in_crewmate_worktree
run_case test_hook_silent_without_jq
run_case test_hook_silent_without_stdin
run_case test_hook_runs_fast
run_case test_grok_adapter_forces_one_resume_when_unhealthy
run_case test_grok_adapter_loop_guard_skips_resume
run_case test_settings_hook_uses_claude_project_dir
run_case test_codex_hook_invokes_shared_guard
run_case test_codex_hook_uses_process_pwd_when_payload_cwd_is_outside_root
run_case test_codex_hook_ignores_nested_git_root_guard
run_case test_opencode_plugin_forces_followup
run_case test_opencode_plugin_anchors_guard_to_worktree
run_case test_pi_extension_forces_followup
run_case test_pi_extension_injects_once_per_logical_agent_run
run_case test_pi_extension_retries_after_followup_delivery_failure
run_case test_grok_hook_invokes_adapter
fm_case_summary "fm-turnend-guard"
