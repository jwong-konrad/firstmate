...
run_case test_no_profile_keeps_claude_launch_unchanged
run_case test_active_dispatch_profile_requires_explicit_harness_for_ship
run_case test_active_dispatch_profile_requires_explicit_harness_for_scout
run_case test_active_dispatch_profile_allows_explicit_harness
run_case test_active_dispatch_profile_allows_positional_harness
run_case test_active_dispatch_profile_allows_raw_launch_command
run_case test_claude_threads_model_and_effort
run_case test_codex_threads_model_and_effort
run_case test_codex_omits_invalid_max_effort
run_case test_grok_threads_model_and_reasoning_effort
run_case test_grok_omits_invalid_max_reasoning_effort
run_case test_grok_omits_invalid_xhigh_reasoning_effort
run_case test_opencode_threads_model_and_ignores_effort_axis
run_case test_pi_threads_model_and_max_effort
run_case test_batch_forwards_shared_profile_flags
run_case test_active_dispatch_profile_does_not_block_secondmate_launch
run_case test_fm_managed_marks_ship_scout_and_secondmate_launches
fm_case_summary "fm-spawn-dispatch-profile"
