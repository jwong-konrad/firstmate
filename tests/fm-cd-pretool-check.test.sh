...
run_case test_fires_in_secondmate_home
run_case test_inert_in_child_worktree
run_case test_inert_when_not_firstmate_repo
run_case test_inert_when_not_a_git_repo
run_case test_e2e_cwd_leak_regression
run_case test_fail_open_empty_stdin
run_case test_fail_open_unparseable_json
run_case test_fail_open_missing_node
run_case test_fail_open_missing_jq_on_stdin
run_case test_prefilter_skips_node_without_cd_substring
run_case test_policy_cli_direct
run_case test_claude_wiring
run_case test_codex_wiring
run_case test_grok_wiring
run_case test_opencode_wiring
run_case test_pi_wiring
run_case test_scripts_are_shellcheck_clean
fm_case_summary "fm-cd-pretool-check"
