...
run_case test_afk_start_refuses_when_flag_cannot_be_written
run_case test_afk_start_ignores_stale_pidfile_without_lock
run_case test_afk_start_reclaims_stale_daemon_lock_reused_pid
run_case test_daemon_state_root_uses_fm_home
run_case test_classify_routine_signal_self
run_case test_classify_terminal_signal_escalates
run_case test_classify_check_and_unknown_escalate
run_case test_stale_transient_self_records_marker
run_case test_stale_terminal_escalates
run_case test_stale_paused_classifies_pause
run_case test_handle_wake_paused_records_pause_marker
run_case test_handle_wake_paused_signal_records_pause_marker
run_case test_handle_wake_terminal_signal_clears_pause_tracking
run_case test_housekeeping_migrates_watcher_pause_marker
run_case test_housekeeping_migrates_watcher_unpaused_marker_to_clear
run_case test_housekeeping_seeds_pause_marker_from_status
run_case test_housekeeping_persistent_stale_escalates
run_case test_housekeeping_resumed_stale_cleared
run_case test_housekeeping_paused_resurfaces_and_resets
run_case test_housekeeping_paused_resumed_cleared
run_case test_housekeeping_paused_unpaused_cleared
run_case test_housekeeping_stale_marker_transitions_to_pause
run_case test_housekeeping_pause_marker_transitions_to_clear
run_case test_housekeeping_herdr_persistent_stale_resolves_meta
run_case test_housekeeping_herdr_idle_busy_footer_clears_stale
run_case test_housekeeping_herdr_resumed_stale_cleared
run_case test_housekeeping_orca_persistent_stale_resolves_terminal
run_case test_escalate_batches_into_one_digest
run_case test_escalate_batch_age_uses_first_append
run_case test_heartbeat_scan_dedup
run_case test_handle_wake_routes_self_and_escalate
run_case test_inject_skip_forces_self
run_case test_is_wake_reason_distinguishes_status_stdout
run_case test_terminal_stale_escalate_leaves_no_marker
run_case test_signal_escalate_marks_seen_no_catchall_refire
run_case test_collapse_newlines_pure
run_case test_afk_absent_daemon_does_not_inject
run_case test_busy_guard_defers_when_supervisor_busy
run_case test_marker_detection
run_case test_afk_turn_exemption
run_case test_should_exit_afk_when_afk_inactive
run_case test_strip_injection_marker
run_case test_pane_input_pending_detects_partial_input
run_case test_pane_input_pending_blank_is_not_pending
run_case test_pane_input_pending_idle_prompt_not_pending
run_case test_tmux_composer_state_bare_shell_is_unknown
run_case test_tmux_composer_state_bordered_and_agent_rows_are_empty
run_case test_tmux_composer_state_requires_matching_box_borders
run_case test_pane_input_pending_honors_idle_override_after_border_strip
run_case test_classify_signal_dedup_against_scan
run_case test_classify_stale_dedup_against_signal
run_case test_afk_nonterminal_working_merged_keeps_wedge_aging
run_case test_afk_genuine_done_still_terminal_stale
run_case test_pane_input_pending_bordered_idle_not_pending
run_case test_pane_input_pending_bordered_with_text_is_pending
run_case test_submit_ack_confirms_on_bordered_empty_composer
run_case test_submit_ack_reports_pending_on_persistent_swallow
run_case test_max_defer_empty_swallow_types_once_and_alarms
run_case test_max_defer_flushes_empty_idle_pane
run_case test_max_defer_pending_composer_alarms_without_typing
run_case test_normal_flush_clears_stale_wedge_marker
run_case test_below_max_defer_does_nothing
run_case test_max_defer_afk_inactive_does_not_flush_or_alarm
run_case test_wedge_alarm_library_mode_defaults_to_discard
run_case test_wake_helpers_replace_inherited_notifier_override
run_case test_wedge_alarm_discard_seam_fires_nothing
run_case test_wedge_alarm_direct_notifiers_honor_discard_seam
run_case test_wedge_alarm_osascript_channel_selected
run_case test_wedge_alarm_herdr_channel_selected
run_case test_wedge_alarm_command_channel_receives_summary
run_case test_wedge_alarm_command_failure_hides_configured_command
run_case test_wedge_alarm_unknown_channel_hides_configured_directive
run_case test_wedge_alarm_off_disables_active_alert_regardless_of_position
run_case test_wedge_alarm_auto_darwin_selects_osascript
run_case test_wedge_alarm_auto_non_darwin_has_no_os_channel
run_case test_wedge_alarm_config_file_multi_channel
run_case test_wedge_alarm_failing_channel_degrades_gracefully
run_case test_wedge_alarm_hung_channel_times_out_and_falls_through
run_case test_wedge_alarm_backgrounded_command_times_out_and_reaps_descendant
run_case test_wedge_alarm_hung_override_times_out_and_falls_through
run_case test_wedge_alarm_shutdown_stops_active_notifier_group
run_case test_inject_wedge_alarm_fires_active_alert_on_non_tmux_backend
run_case test_inject_wedge_alarm_throttles_when_marker_cannot_be_written
run_case test_fm_send_exits_nonzero_on_confirmed_swallow
run_case test_fm_send_exits_nonzero_on_initial_send_failure
run_case test_discover_supervisor_backend_precedence
run_case test_discover_supervisor_target_herdr
run_case test_pane_is_busy_herdr_native_busy_state
run_case test_pane_is_busy_herdr_falls_back_to_capture_regex
run_case test_pane_is_busy_herdr_idle_falls_back_to_capture_regex
run_case test_pane_is_busy_defaults_to_tmux_when_backend_omitted
run_case test_pane_input_pending_herdr_dispatch
run_case test_inject_msg_herdr_busy_guard_defers
run_case test_inject_msg_herdr_composer_guard_defers
run_case test_inject_msg_herdr_pane_gone_defers
run_case test_inject_msg_herdr_submits_through_backend_dispatch
run_case test_inject_msg_defers_on_dead_shell_unknown
fm_case_summary "fm-daemon"
