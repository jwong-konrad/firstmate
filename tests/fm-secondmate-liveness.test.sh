...
run_case test_tmux_agent_alive_classifies
run_case test_herdr_agent_alive_maps_pane_agent_state
run_case test_agent_alive_dispatcher_routes_and_falls_back
run_case test_sweep_respawns_confirmed_dead_secondmate
run_case test_sweep_leaves_alive_secondmate_untouched
run_case test_sweep_never_acts_on_inconclusive_reading
run_case test_sweep_never_acts_on_unverified_harness_dead_reading
run_case test_sweep_converges_no_retouch_once_alive
run_case test_sweep_skipped_under_detect_only
run_case test_sweep_noop_with_no_secondmate_meta
fm_case_summary "fm-secondmate-liveness"
