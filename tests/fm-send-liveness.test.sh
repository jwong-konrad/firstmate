...
run_case test_bare_shell_is_classified_as_dead_agent_not_alive
run_case test_gone_endpoint_is_distinct_from_bare_shell
run_case test_unreachable_tmux_is_inconclusive_never_dead
run_case test_herdr_maps_no_agent_to_shell_and_gone_pane_to_no_endpoint
run_case test_pane_agent_state_survives_a_zsh_shell
run_case test_send_refuses_a_bare_shell_and_types_nothing
run_case test_send_refuses_a_gone_endpoint_without_typing
run_case test_send_to_a_live_agent_is_unchanged
run_case test_send_on_an_inconclusive_read_still_delivers
run_case test_key_path_is_never_gated_on_agent_liveness
run_case test_bare_shell_refusal_precedes_any_pending_reply_record
fm_case_summary "fm-send-liveness"
