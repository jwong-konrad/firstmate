...
OLD_BIN_UNCHANGED_SIBLINGS="fm-gate-refuse-lib.sh fm-guard.sh fm-lock-lib.sh fm-tasks-axi-lib.sh fm-pr-lib.sh fm-tangle-lib.sh fm-tmux-lib.sh fm-composer-lib.sh fm-marker-lib.sh fm-wake-lib.sh fm-classify-lib.sh fm-supervision-lib.sh fm-progress-lib.sh fm-ff-lib.sh fm-config-inherit-lib.sh fm-project-mode.sh fm-harness.sh fm-crew-state.sh fm-decision-hold.sh fm-backend.sh"
...
run_case test_backend_name_precedence
run_case test_backend_detect_precedence
run_case test_backend_detect_cmux_fallback_bundle_id
run_case test_backend_detect_cmux_fallback_requires_darwin
run_case test_backend_detect_cmux_fallback_tmux_nested_false_positive
run_case test_backend_detect_cmux_fallback_ancestry_pid_match
run_case test_backend_detect_cmux_fallback_ancestry_comm_match
run_case test_backend_detect_cmux_fallback_ancestry_stops_at_launchd
run_case test_backend_name_cmux_fallback_notice
run_case test_backend_name_autodetect_notice
run_case test_backend_name_explicit_beats_detection
run_case test_backend_validate_refuses_unknown
run_case test_backend_source_shell_portable
run_case test_backend_validate_spawn_accepts_orca
run_case test_meta_get_and_backend_of_meta
run_case test_resolve_selector_three_forms
run_case test_backend_of_selector_matches_explicit_target_meta
run_case test_send_conformance_old_vs_new
run_case test_peek_conformance_old_vs_new
run_case test_spawn_symlinked_project_prefix_avoids_false_refusal
run_case test_teardown_conformance_old_vs_new
run_case test_spawn_refuses_unknown_backend_flag
run_case test_spawn_refuses_codex_app_backend_flag
run_case test_spawn_refuses_unknown_fm_backend_env
run_case test_spawn_default_backend_writes_no_meta_field
run_case test_spawn_explicit_backend_flag_beats_autodetect_herdr_env
run_case test_spawn_autodetect_nesting_resolves_tmux_silently
fm_case_summary "fm-backend"
