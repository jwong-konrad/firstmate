...
run_case test_strip_ghost_drops_dim_keeps_normal
run_case test_strip_ghost_handles_combined_and_boundary_codes
run_case test_strip_ghost_keeps_colored_text_with_2_payloads
run_case test_strip_ghost_drops_dark_truecolor_ghost
run_case test_dim_ghost_only_composer_is_not_pending
run_case test_dim_ghost_inside_bordered_composer_is_not_pending
run_case test_normal_text_still_pending
run_case test_colored_text_with_2_payload_still_pending
run_case test_dark_truecolor_ghost_only_composer_is_not_pending
run_case test_dark_truecolor_bare_shell_prompt_is_unknown
run_case test_real_text_with_trailing_ghost_is_pending
run_case test_peek_output_is_escape_free
fm_case_summary "fm-composer-ghost"
