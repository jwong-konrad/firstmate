...
run_case test_new_skill_metadata_and_triggers
run_case test_migrated_operational_learnings_sit_in_trigger_matched_sections
run_case test_diagnostic_owner_covers_causal_procedure
run_case test_project_management_owner_covers_guarded_operations
run_case test_generic_effort_fallback_respects_precedence
run_case test_shared_authoring_requirements_are_owned
run_case test_secondmate_registry_contract_stays_concise
run_case test_state_startup_and_ordinary_recovery_placement
run_case test_compressed_agents_owner_map
run_case test_compressed_agents_retains_authority_and_supervision_safety
fm_case_summary "fm-instruction-owners"
