...
run_case test_empty_fleet_json
run_case test_fixture_snapshot_json
run_case test_main_inventory_orphan_and_unstructured_disclosure
run_case test_event_hints_follow_reconciled_current_state
run_case test_open_decision_survives_later_unrelated_event
run_case test_secondmate_open_decision_survives_live_endpoint
run_case test_open_decision_transfers_to_captain_hold
run_case test_open_decision_clears_on_keyed_resolution
run_case test_completed_scout_report_is_pointer_not_pending
run_case test_parked_scout_decision_stays_pending
run_case test_scout_reports_include_teardown_reports
run_case test_backlog_tasks_axi_forms_and_overrides
run_case test_view_renders_snapshot
run_case test_view_renders_dead_secondmate_agent_status
fm_case_summary "fm-fleet-snapshot-view"
