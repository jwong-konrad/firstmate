...
run_case test_list_all_exact_suite_coverage
run_case test_family_selection
run_case test_single_script_selection
run_case test_changed_file_selection_is_conservative
run_case test_changed_dependency_selection_and_unmapped_failure
run_case test_empty_selection_emits_summary
run_case test_timing_markers_and_json
run_case test_aggregate_exit_behavior
run_case test_gate_skip_accounting
run_case test_fail_on_gate_skip_token
run_case test_exclude_family
run_case test_ci_and_docs_call_the_owner
run_case test_portable_shard_union_and_coverage_guard
run_case test_jobs_requires_proven_isolated
run_case test_jobs_parallel_scheduler_and_failure_propagation
run_case test_aggregate_json
fm_case_summary "fm-test-run"
