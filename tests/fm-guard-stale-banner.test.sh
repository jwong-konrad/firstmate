...
run_case test_first_stale_call_prints_full_banner
run_case test_repeated_same_episode_prints_reminder_only
run_case test_healthy_recovery_rearms_next_stale_episode
run_case test_concurrent_same_episode_prints_one_full_banner
run_case test_home_isolation
run_case test_queued_wake_warning_stays_independent
run_case test_read_only_before_writable_does_not_consume_full_banner
run_case test_read_only_during_episode_observes_without_mutating_marker
run_case test_healthy_read_only_does_not_clear_marker
run_case test_read_only_never_mutates_stale_banner_state_files
fm_case_summary "fm-guard-stale-banner"
