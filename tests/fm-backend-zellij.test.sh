...
run_case test_version_check_accepts_current_version
run_case test_version_check_accepts_newer_version
run_case test_version_check_refuses_old_version
run_case test_version_check_refuses_missing_zellij
run_case test_session_defaults_to_firstmate
run_case test_session_honors_override
run_case test_parse_target
run_case test_normalize_key
run_case test_scoped_title_uses_primary_home_label
run_case test_scoped_title_uses_secondmate_home_label
run_case test_scoped_title_changes_with_root_path
run_case test_expected_label_accepts_unambiguous_untagged_legacy_tab
run_case test_expected_label_refuses_ambiguous_untagged_tab
run_case test_list_live_scopes_to_own_home_tag
run_case test_resolve_bare_selector_prefers_scoped_title
run_case test_resolve_bare_selector_refuses_ambiguous_untagged
run_case test_resolve_bare_selector_prefers_later_session_scoped_title_over_legacy
run_case test_resolve_bare_selector_refuses_cross_session_ambiguous_untagged
run_case test_session_exists_true_when_listed
run_case test_session_exists_false_when_absent
run_case test_server_ensure_skips_attach_when_already_exists
run_case test_dispatch_routes_zellij_backend
run_case test_dispatch_busy_state_unknown_for_zellij
run_case test_create_task_refuses_duplicate_label
run_case test_create_task_creates_and_parses_ids
run_case test_create_task_restores_previously_active_tab
run_case test_create_task_no_restore_when_new_tab_was_already_active
run_case test_capture_small_reads_use_viewport_and_trim
run_case test_capture_large_reads_use_full_scrollback_and_trim
run_case test_capture_fails_when_pane_absent
run_case test_capture_fails_when_session_absent
run_case test_send_key_normalizes_and_targets_pane
run_case test_send_literal_uses_paste_separator_for_option_shaped_text
run_case test_expected_label_allows_matching_task_tab
run_case test_expected_label_rejects_reused_pane_id
run_case test_current_path_probes_with_marker_and_ignores_prompt_paths
run_case test_current_path_ignores_tilde_prefixed_banner_lines
run_case test_kill_resolves_tab_and_closes_by_id
run_case test_kill_falls_back_to_close_pane_when_tab_lookup_empty
run_case test_kill_closes_recorded_tab_when_pane_already_gone
run_case test_kill_skips_recorded_tab_when_label_mismatches
run_case test_kill_is_noop_when_session_absent
run_case test_teardown_passes_recorded_tab_id_to_zellij_kill
run_case test_forced_secondmate_teardown_kills_zellij_children_with_child_home_tag
run_case test_send_text_submit_detects_landed_send
run_case test_send_text_submit_detects_swallowed_enter
run_case test_send_text_submit_send_failed_when_session_absent
run_case test_send_text_submit_send_failed_when_pane_absent
run_case test_scripts_route_explicit_target_through_meta_backend
run_case test_scripts_verify_label_for_fm_targets
run_case test_scripts_reject_fm_target_label_mismatch
fm_case_summary "fm-backend-zellij"
