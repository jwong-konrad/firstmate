...
run_case test_orca_backend_gates_orca_tool_only_when_selected
run_case test_session_provider_backends_do_not_require_tmux
run_case test_session_provider_backends_gate_own_cli_not_tmux
run_case test_herdr_install_requires_manual_action
run_case test_cmux_bundled_cli_satisfies_dependency
run_case test_unknown_backend_reports_invalid_configuration
run_case test_json_backends_require_jq_not_tmux
run_case test_treehouse_lease_check_follows_resolved_backend
run_case test_fleet_sync_timeout_scales_with_origin_backed_project_count
run_case test_fleet_sync_timeout_floor_preserves_small_fleets
run_case test_fleet_sync_timeout_explicit_override_wins
run_case test_fleet_sync_timeout_empty_override_uses_default
run_case test_fleet_sync_timeout_is_computed_before_launch
run_case test_routine_bootstrap_confirmations_are_silent
run_case test_routine_bootstrap_contract_runs_under_system_bash
