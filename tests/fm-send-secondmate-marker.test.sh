...
run_case test_secondmate_target_is_marked
run_case test_exact_secondmate_task_id_is_marked
run_case test_crewmate_target_is_not_marked
run_case test_explicit_window_is_not_marked
run_case test_key_path_is_not_marked
run_case test_marker_is_label_plus_invisible_separator
run_case test_marker_transformation_is_idempotent
run_case test_marked_send_preserves_trailing_newlines
fm_case_summary "fm-send-secondmate-marker"
