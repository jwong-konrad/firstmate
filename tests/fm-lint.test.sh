...
run_case test_owner_exists_and_executable
run_case test_owner_defines_canonical_set
run_case test_ci_invokes_the_owner
run_case test_nomistakes_invokes_the_owner
run_case test_pins_an_explicit_version
run_case test_ci_installs_and_logs_the_pinned_version
run_case test_rejects_wrong_shellcheck_version
run_case test_catches_a_real_lint_defect
run_case test_ignores_ambient_shellcheck_opts
run_case test_clean_fixture_passes
fm_case_summary "fm-lint"
