...
run_case test_configured_checkout_is_pulled
run_case test_kill_switch_skips_the_pull
run_case test_held_lock_skips_the_pull_and_names_it
run_case test_absent_config_is_silent
run_case test_unlisted_project_is_silent
run_case test_missing_path_warns_and_spawns
run_case test_relative_path_warns_and_spawns
run_case test_non_git_path_warns_and_spawns
run_case test_key_with_no_path_warns_and_spawns
run_case test_failed_pull_warns_and_spawns
run_case test_project_clone_in_this_home_is_never_pulled
run_case test_rejected_timeout_value_is_named_not_silently_replaced
run_case test_valid_timeout_value_is_silent
run_case test_refused_spawn_mutates_nothing
run_case test_path_inside_this_home_is_never_pulled
run_case test_firstmate_repo_root_is_never_pulled
run_case test_whitespace_path_is_named_not_misdiagnosed
fm_case_summary "fm-spawn-app-checkouts"
