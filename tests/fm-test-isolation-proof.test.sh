...
run_case test_list_candidates_nonempty_and_stable
run_case test_candidates_exclude_serial_classes
run_case test_candidates_match_archived_proof
run_case test_extra_hermetic_candidates_present
run_case test_list_exclusions_documents_reasons
run_case test_family_map_labels_this_contract
run_case test_aggregate_failure_under_concurrency
run_case test_phase4_consumes_proven_set_only
run_case test_docs_record_proof_owner
fm_case_summary "fm-test-isolation-proof"
