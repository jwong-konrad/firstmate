...
run_case test_token_verdict_mapping
run_case test_record_absent_reads_progressing
run_case test_record_roundtrip_and_invalidation
run_case test_record_invalidated_by_changed_evidence
run_case test_record_expires_on_absolute_ttl
run_case test_idle_verdict_expires_while_its_evidence_stays_identical
run_case test_progressing_verdict_is_not_bound_by_the_idle_horizon
run_case test_record_rejects_corrupt_content
run_case test_count_parked_fleet_versus_live_fleet
run_case test_count_unrecorded_task_counts_progressing
run_case test_pollable_work_detected
run_case test_reconcile_maps_and_persists
run_case test_reconcile_rejects_a_stale_status_log_reading
run_case test_reconcile_keeps_a_live_source_over_an_old_status_log
run_case test_arm_declines_when_every_task_is_idle
run_case test_arm_declines_with_no_tasks_at_all
run_case test_arm_proceeds_with_one_progressing_task
run_case test_arm_proceeds_for_an_unrecorded_working_task
run_case test_arm_declines_for_a_dead_endpoint
run_case test_arm_proceeds_for_an_armed_check_poll
run_case test_arm_force_overrides_the_gate
run_case test_arm_gate_precedes_restart_teardown
run_case test_arm_reconciles_on_a_cache_miss
run_case test_arm_gate_budget_exhaustion_arms_rather_than_declines
run_case test_arm_gate_kills_a_reconcile_that_outruns_the_ceiling
run_case test_arm_gate_declines_when_the_budget_is_ample
run_case test_a_declined_arm_leaves_records_the_guards_read_the_same_way
run_case test_arm_re_observes_a_task_whose_idle_verdict_went_stale
fm_case_summary "fm-progress-arming"
