...
run_case test_version_check_accepts_current_protocol
run_case test_version_check_refuses_old_protocol
run_case test_version_check_refuses_missing_herdr
run_case test_workspace_label_primary_home_no_marker
run_case test_workspace_label_secondmate_home_uses_marker_id
run_case test_workspace_label_secondmate_marker_trims_whitespace
run_case test_workspace_label_empty_marker_falls_back_to_primary
run_case test_workspace_label_different_secondmates_get_different_labels
run_case test_cli_helper_sets_env_and_appends_trailing_session_flag
run_case test_container_ensure_starts_server_and_workspace
run_case test_container_ensure_reuses_existing_workspace
run_case test_container_ensure_creates_with_no_focus_flag
run_case test_container_ensure_uses_secondmate_home_label
run_case test_workspace_ensure_prunes_default_tab
run_case test_repeated_cycles_reuse_one_workspace_no_orphans
run_case test_adopted_workspace_never_prunes_default_tab
run_case test_label_collision_startup_workspace_leaves_live_tab_alone
run_case test_prune_refuses_a_working_agent_pane_defense_in_depth
run_case test_no_jq_reserved_keyword_arg_names
run_case test_create_task_refuses_duplicate_label
run_case test_create_task_refuses_duplicate_label_when_agent_live
run_case test_create_task_refuses_when_any_duplicate_label_is_live
run_case test_create_task_closes_and_replaces_dead_pane_husk
run_case test_create_task_closes_and_replaces_no_agent_husk
run_case test_create_task_closes_all_duplicate_husks_after_replacement
run_case test_create_task_refuses_when_preexisting_husk_tab_remains
run_case test_create_task_refuses_when_agent_state_ambiguous
run_case test_create_task_husk_replacement_creates_before_closing
run_case test_create_task_creates_and_parses_ids
run_case test_create_task_creates_with_no_focus_flag
run_case test_projection_journal_is_atomic_and_uses_128_bit_token
run_case test_projection_create_uses_exact_response_ids_and_leaves_one_task_pane
run_case test_projection_create_never_closes_a_concurrent_same_label_tab
run_case test_projection_focus_snapshot_requires_exact_workspace_and_tab
run_case test_projection_close_restores_exact_prior_focus
run_case test_projection_close_refuses_active_tab
run_case test_projection_seeded_prune_refuses_active_tab
run_case test_projection_label_builder_uses_corner_and_strips_owner_prefixes
run_case test_projection_order_moves_only_exact_new_workspace_and_preserves_relative_order
run_case test_projection_order_secondmate_parent_block
run_case test_projection_order_foreign_legacy_child_is_read_only
run_case test_projection_order_allows_intervening_parent_child_block
run_case test_projection_order_human_spaces_never_move_targets
run_case test_projection_order_failure_warns_without_cleanup_or_spawn_failure
run_case test_projection_order_ambiguous_existing_block_is_read_only
run_case test_projection_order_foreign_new_child_before_parent_is_read_only
run_case test_projection_order_missing_parent_is_read_only
run_case test_presentation_session_lock_path_is_shared_across_homes
run_case test_presentation_session_lock_path_rejects_malformed_socket
run_case test_presentation_lock_malformed_socket_falls_back
run_case test_projection_order_rejects_malformed_socket
run_case test_presentation_lock_insecure_namespace_falls_back
run_case test_spawn_task_lock_covers_all_backend_creation_and_metadata_publication
run_case test_projected_spawn_disarms_cleanup_before_ambiguous_launch_submission
run_case test_projected_abort_cleanup_holds_presentation_lock
run_case test_projection_recovery_is_read_only_and_refuses_live_duplicate_risk
run_case test_workspace_find_matches_only_this_homes_own_label
run_case test_list_live_scoped_to_this_homes_workspace_only
run_case test_parse_target
run_case test_normalize_key
run_case test_capture_calls_pane_read
run_case test_capture_works_around_small_lines_bug
run_case test_capture_preserves_pane_read_failure
run_case test_send_key_normalizes_and_targets_pane
run_case test_kill_is_best_effort
run_case test_current_path_reads_cwd
run_case test_busy_state_working_maps_to_busy
run_case test_busy_state_done_and_blocked_map_to_idle
run_case test_busy_state_unknown_on_no_agent
run_case test_composer_state_bare_prompt_is_empty
run_case test_composer_state_ghost_placeholder_is_empty
run_case test_composer_state_real_text_is_pending
run_case test_composer_state_popup_placeholder_fill_is_pending
run_case test_composer_state_unknown_on_capture_failure
run_case test_composer_state_unknown_when_no_composer_row_found
run_case test_composer_state_pi_separator_idle_is_empty
run_case test_composer_state_pi_separator_real_text_is_pending
run_case test_composer_state_pi_incomplete_separator_below_stale_generic_is_unknown
run_case test_composer_state_pi_separator_requires_safe_native_identity
run_case test_composer_state_claude_unbordered_prompt_is_empty
run_case test_composer_state_claude_unbordered_prompt_is_pending
run_case test_composer_state_bare_prompt_below_stale_bordered_banner_wins
run_case test_composer_state_claude_dim_prompt_suggestion_ghost_is_empty
run_case test_composer_state_claude_dim_ghost_row_with_real_text_is_pending
run_case test_composer_state_grok_dark_truecolor_placeholder_is_empty
run_case test_composer_state_grok_bright_truecolor_real_text_is_pending
run_case test_composer_state_codex_bare_prompt_glyph_is_empty
run_case test_composer_state_codex_faint_suggestion_is_empty
run_case test_composer_state_codex_non_faint_same_text_is_pending
run_case test_wait_for_working_returns_busy_on_first_poll
run_case test_wait_for_working_catches_a_slow_transition_mid_window
run_case test_wait_for_working_samples_budget_endpoint_without_final_sleep
run_case test_send_text_submit_applies_herdr_minimum_confirm_budget
run_case test_wait_for_working_returns_idle_when_never_busy_but_readable
run_case test_wait_for_working_returns_unknown_when_never_readable
run_case test_wait_for_working_treats_blocked_as_submit_active
run_case test_send_text_submit_detects_landed_send
run_case test_send_text_submit_detects_swallowed_enter
run_case test_send_text_submit_popup_autocomplete_requires_second_enter
run_case test_send_text_submit_confirms_blocked_after_enter
run_case test_send_text_submit_preexisting_working_does_not_false_confirm_swallowed_enter
run_case test_send_text_submit_confirms_despite_codex_idle_tip_composer
run_case test_composer_state_codex_dynamic_idle_tip_reads_empty_when_faint
run_case test_composer_state_guard_still_refuses_real_pending_text_after_submit_confirmation_change
run_case test_send_text_submit_slow_transition_within_one_enter_needs_no_extra_enter
run_case test_send_text_submit_send_failed
run_case test_send_text_submit_unknown_on_capture_failure
run_case test_dispatch_routes_herdr_backend
run_case test_dispatch_busy_state_unknown_for_tmux
run_case test_dispatch_composer_state_routes_by_backend
run_case test_scripts_route_explicit_target_through_meta_backend
run_case test_normalize_event_leaves_from_empty
run_case test_escalation_marker_keys_like_watcher
run_case test_apply_transition_blocked_requires_commit_to_dedupe
run_case test_apply_transition_working_clears_marker
run_case test_clear_transition_removes_task_marker
run_case test_apply_transition_defer_and_fallback_are_noops
run_case test_wait_transition_no_panes_returns_2
run_case test_wait_transition_not_capable_returns_2
run_case test_wait_transition_reconcile_blocked_returns_record
run_case test_wait_transition_subscribes_before_reconcile
run_case test_wait_transition_reconcile_dedupes_when_marked
run_case test_wait_transition_stream_blocked_returns_record
run_case test_wait_transition_stream_absorb_clears_then_timeout
run_case test_wait_transition_reader_failure_returns_2
run_case test_wait_transition_bad_ack_returns_2_and_cleans_up
run_case test_wait_transition_clean_timeout_returns_1
fm_case_summary "fm-backend-herdr"
