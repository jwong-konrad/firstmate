...
run_case test_harness_resolution
run_case test_secondmate_model_effort_tokens
run_case test_propagate_lib
run_case test_spawn_split_and_inherit
run_case test_spawn_backward_compat_crew_fallback
run_case test_spawn_bare_backward_compat
run_case test_spawn_explicit_harness_wins
run_case test_spawn_unverified_secondmate_harness_refused
run_case test_spawn_bare_harness_no_model_effort_flag
run_case test_spawn_secondmate_harness_model_token
run_case test_spawn_secondmate_harness_model_and_effort_tokens
run_case test_spawn_explicit_model_overrides_secondmate_harness_token
run_case test_spawn_explicit_effort_overrides_secondmate_harness_token
run_case test_spawn_explicit_harness_does_not_inherit_secondmate_harness_tokens
run_case test_spawn_explicit_harness_uses_explicit_profile_axes
run_case test_spawn_fallback_chain_and_crew_scout_unaffected
run_case test_bootstrap_sweep_propagates_and_reconverges
run_case test_bootstrap_sweep_propagates_when_tracked_current
run_case test_bootstrap_sweep_defers_dispatch_on_stale_unignored_home
run_case test_bootstrap_sweep_no_inheritance_is_noop
run_case test_bootstrap_sweep_surfaces_config_propagation_failure
run_case test_bootstrap_rereads_after_partial_propagation
run_case test_config_push_propagates_reports_without_ff_or_nudge
run_case test_config_push_reports_skips_dirty_and_invalid_home
run_case test_config_push_exits_nonzero_on_copy_error
run_case test_config_push_rereads_after_partial_propagation
run_case test_config_reread_per_home_changed_sets_and_exact_bytes
run_case test_config_reread_isolation_and_absent_and_send_failure
run_case test_config_reread_publication_failure_retries_exact_generation
run_case test_config_reread_write_failure_retains_exact_retry_generation
run_case test_config_reread_exact_temp_survives_adoption_failure
run_case test_config_reread_serializes_concurrent_pushes
run_case test_config_reread_full_retry_queue_drains_before_new_push
run_case test_config_reread_cleanup_runs_after_mixed_delivery_failure
run_case test_config_reread_stops_after_failed_generation
run_case test_config_reread_skips_when_unchanged_and_reads_after_push
run_case test_config_reread_bootstrap_path_and_spawn_flexibility
run_case test_bootstrap_respawns_before_config_reread
run_case test_spawn_quarantines_pending_rereads_on_cleanup_failure
run_case test_bootstrap_detect_only_does_not_create_state
fm_case_summary "fm-secondmate-harness"
