...
run_case test_local_only_fork_remote_allows
run_case test_teardown_prompts_tasks_axi_done_when_compatible
run_case test_teardown_manual_backend_prompts_hand_edit_even_when_tasks_axi_present
run_case test_local_only_truly_unpushed_refuses
run_case test_local_only_merged_to_local_main_allows
run_case test_no_mistakes_origin_remote_allows
run_case test_no_mistakes_truly_unpushed_refuses
run_case test_local_only_force_overrides_unpushed
run_case test_herdr_teardown_clears_escalation_marker
run_case test_herdr_projection_teardown_retires_journal_only_after_confirmed_close
run_case test_herdr_projection_teardown_retains_journal_when_close_unconfirmed
run_case test_squash_merged_branch_deleted_allows
run_case test_squash_merged_pr_allows_when_head_ancestor_of_pr_head
...
run_case test_content_fallback_refreshes_stale_origin_ref
run_case test_dirty_worktree_refuses
run_case test_gh_error_and_content_absent_refuses
run_case test_stale_index_lock_cleared_and_teardown_succeeds
run_case test_live_index_lock_is_never_removed_and_teardown_refuses
run_case test_lsof_error_never_clears_index_lock
run_case test_stale_index_lock_cleanup_rechecks_dirty_worktree
run_case test_non_linked_index_lock_path_is_checked_from_worktree
run_case test_index_lock_mtime_read_failure_refuses
run_case test_transient_index_lock_clears_after_first_attempt_and_retry_succeeds
run_case test_persistent_index_lock_exhausts_retries_and_refuses_loudly
run_case test_transient_bare_reset_race_clears_after_first_attempt_and_retry_succeeds
run_case test_persistent_bare_reset_race_exhausts_retries_and_refuses_loudly
run_case test_real_reset_failure_with_diagnostic_text_aborts_immediately
run_case test_empty_retry_wait_uses_default_without_aborting
run_case test_fractional_legacy_retry_wait_refuses_without_arithmetic_error
fm_case_summary "fm-teardown"
