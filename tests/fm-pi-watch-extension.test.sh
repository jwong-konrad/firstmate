...
run_case test_tracked_extension_present_and_self_hashing
run_case test_spawn_template_mentions_pi_watch_placeholder
run_case test_pi_extension_reports_external_healthy_watcher
run_case test_pi_tool_returns_agent_tool_result
run_case test_pi_actionable_close_starts_single_successor_before_delivery
run_case test_pi_declined_arm_is_quiet_and_never_retries
run_case test_pi_declined_successor_restores_quietly
run_case test_pi_hung_successor_falls_back_to_typed_wake
run_case test_pi_unretired_successor_falls_back_without_retry
run_case test_pi_late_unretired_close_resumes_supervision
run_case test_pi_empty_close_retries_instead_of_disappearing
run_case test_pi_established_empty_close_honors_retry_limit
run_case test_pi_actionable_close_rechecks_session_lock
run_case test_pi_arm_distinguishes_session_lock_ownership
run_case test_pi_process_exit_cleanup_listener_lifecycle
run_case test_pi_process_exit_cleanup_stops_arm_child
run_case test_opencode_primary_watch_plugin_static_wiring
run_case test_opencode_plugin_package_boundary_is_explicit_esm
run_case test_opencode_primary_watch_plugin_uses_effective_state_home
run_case test_opencode_primary_watch_plugin_sources_effective_config
run_case test_opencode_primary_watch_plugin_requires_session_lock
run_case test_opencode_watch_arm_coordinator_respects_primary_scope
run_case test_opencode_primary_watch_plugin_rearms_after_wake
run_case test_opencode_pre_ready_actionable_close_preserves_its_successor
run_case test_opencode_hung_successor_falls_back_to_typed_wake
run_case test_opencode_unretired_successor_falls_back_without_retry
run_case test_opencode_late_unretired_close_resumes_supervision
run_case test_opencode_empty_close_retries_instead_of_disappearing
run_case test_opencode_declined_arm_is_quiet_and_never_retries
run_case test_opencode_declined_successor_restores_quietly
run_case test_opencode_established_empty_close_honors_retry_limit
run_case test_opencode_actionable_close_rechecks_session_lock
run_case test_opencode_watch_arm_coordinates_with_turnend_guard
run_case test_opencode_healthy_arm_output_does_not_suppress_guard
fm_case_summary "fm-pi-watch-extension"
