...
run_case test_gate_scope_and_recovery_exceptions
run_case test_live_lock_allows_fleet_command_even_with_stale_beacon
run_case test_child_worktree_and_malformed_input_fail_open
run_case test_serviced_wake_does_not_deadlock_recovery
run_case test_only_a_delivered_wake_opens_the_service_window
run_case test_reader_classifies_every_reason_the_writer_emits
run_case test_turnend_guard_grants_no_service_grace
run_case test_claude_hook_registration_preserves_stop_backstop
fm_case_summary "fm-continuity-pretool-check"
