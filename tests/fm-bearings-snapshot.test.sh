...
run_case test_domain_alpha_stale_parent_event_does_not_become_current_work
run_case test_gnu_stat_uses_file_formats_without_bsd_fallback_pollution
run_case test_parent_activity_evidence_is_bounded_and_disclosed
run_case test_active_child_overrides_old_parent_event
run_case test_structured_child_decision_reaches_captains_call
run_case test_bad_secondmate_homes_never_revive_parent_work
run_case test_secondmate_and_child_bounds_are_disclosed
run_case test_parent_decision_is_untrusted_contradiction_only
run_case test_parent_evidence_reconciles_by_verb_and_key
run_case test_nonprogressing_child_states_are_explicit
run_case test_registry_unavailability_and_bounds_are_explicit
run_case test_current_landed_baseline_is_repeatable_and_prior_report_independent
run_case test_default_is_bounded_and_local_only
run_case test_toon_json_parity
run_case test_landed_includes_secondmate_home_merges
run_case test_landed_default_balances_dominant_and_sparse_homes
run_case test_landed_default_refills_capacity_after_sparse_homes_exhaust
run_case test_landed_default_uses_deterministic_home_order_when_homes_exceed_cap
run_case test_landed_default_preserves_internal_order_for_ties
run_case test_landed_default_handles_no_landed_items
run_case test_all_landed_keeps_complete_global_order
run_case test_landed_bounded_and_disclosed
run_case test_live_blocker_is_not_charted_queue_work
run_case test_captains_call_anti_leak
run_case test_main_orphan_in_flight_is_disclosed_not_invented
run_case test_main_unstructured_current_is_disclosed_with_structured_sibling
run_case test_main_orphan_counterfactual_meta_clears_inventory_warning
run_case test_chat_contract_four_sections
run_case test_completed_scout_report_not_pending
run_case test_open_decision_surfaces_end_to_end
run_case test_report_pointers_surface
run_case test_superseded_queued_item_dropped_by_default
run_case test_include_prs_is_the_only_fetch_path
run_case test_partial_github_failure_degrades
run_case test_perl_fallback_bounds_github_call
run_case test_section_caps_and_expansion_flags
run_case test_pr_repository_cap_and_expansion
run_case test_per_repository_pr_cap_is_disclosed
run_case test_projection_and_toon_fail_closed
fm_case_summary "fm-bearings-snapshot"
