...
run_case test_first_copy_readonly_and_local_files_preserved
run_case test_drift_quarantine_collision_and_repeated_convergence
run_case test_missing_source_mirrors_absence_without_losing_local_bytes
run_case test_unsafe_artifacts_and_failure_restore_readonly_mode
run_case test_spawn_convergence_point_copies_shared_file
run_case test_bootstrap_convergence_point_copies_shared_file
run_case test_config_push_convergence_point_updates_changed_source
run_case test_session_start_digest_labels_shared_file_and_read_once_rule
fm_case_summary "fm-shared-captain-inheritance"
