...
run_case test_active_run_is_authoritative
run_case test_stale_needs_decision_superseded
run_case test_stale_blocked_superseded
run_case test_genuine_parked_not_superseded
run_case test_scalar_gate_parked_not_superseded
run_case test_gate_block_parked_not_superseded
run_case test_ci_ready_done_log_beats_monitoring_run
run_case test_ci_monitoring_checks_green_surfaces_done
run_case test_top_level_ci_checks_green_surfaces_done
run_case test_ci_monitoring_no_checks_terminal_surfaces_done
run_case test_ci_monitoring_green_then_rearm_stays_working
run_case test_ci_monitoring_no_checks_yet_stays_working
run_case test_ci_monitoring_still_waiting_stays_working
run_case test_ci_monitoring_green_then_new_issue_stays_working
run_case test_ci_ready_done_log_relapse_stays_working
run_case test_ci_fixing_after_green_stays_working
run_case test_top_level_fixing_ci_running_after_green_stays_working
run_case test_top_level_fixing_done_log_stays_working
run_case test_terminal_passed
run_case test_terminal_failed
run_case test_cross_branch_attribution_via_runs_list
run_case test_cross_branch_attribution_picks_most_recent_row
run_case test_coarse_run_does_not_probe_other_branch_ci_log_for_ready_status
run_case test_other_branch_run_ignored
run_case test_no_run_busy_pane
run_case test_no_run_herdr_unknown_uses_backend_capture
run_case test_no_run_herdr_idle_agent_status_corroborated_by_busy_pane
run_case test_no_run_herdr_idle_agent_status_and_idle_pane_stays_idle
run_case test_no_run_idle_pane_uses_log
run_case test_no_run_idle_pane_uses_keyed_log
run_case test_no_run_idle_pane_paused
run_case test_no_run_idle_pane_custom_paused_verb
run_case test_no_run_idle_secondmate_resolved_event_not_state
run_case test_dead_window_ignores_stale_status_log
run_case test_dead_window_still_reports_terminal_run_step
run_case test_dead_window_still_reports_active_run_step
run_case test_no_timeout_uses_perl_bound
run_case test_scout_skips_run_lookup
run_case test_torn_down_worktree
run_case test_missing_meta
run_case test_provably_working_via_runs_list_fallback
run_case test_not_provably_working_when_stopped
run_case test_usage_error
run_case test_historical_same_branch_rewritten_head_not_current
