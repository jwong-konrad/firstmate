...
run_case test_parser_matrix
run_case test_gitlab_merge_watch
run_case test_invalid_entrypoints_have_zero_side_effects
run_case test_valid_recording_and_merge_derivation
run_case test_rejected_metacharacter_bytes_are_inert
run_case test_static_poll_contract
run_case test_atomic_interruption_leaves_no_partial_artifact
run_case test_concurrent_watcher_sees_only_complete_publication
run_case test_postrename_poll_validation_revokes_and_retries
run_case test_migration_initializes_fresh_state
run_case test_migration_excludes_older_watcher_before_scan
run_case test_private_artifact_paths_refuse_symlinks_and_directories
run_case test_marker_and_diagnostic_rename_fail_closed
run_case test_postrename_marker_and_diagnostic_validation_retries
run_case test_quarantine_validation_and_retry_contract
run_case test_failed_outcomes_block_every_retry_until_repaired
run_case test_ambiguous_failure_accepts_validated_replacement
run_case test_replacement_provenance_negative_matrix
run_case test_complete_single_link_validation
run_case test_canonical_publication_failure_recovers_only_on_retry
run_case test_obligation_namespace_compatibility
run_case test_nonexecuting_migration
run_case test_historical_x_shim_transition_matrix
run_case test_direct_registration_refreshes_v1_x_shim
run_case test_bootstrap_migrates_before_other_mutations
run_case test_bootstrap_isolates_incomplete_poll_migration
run_case test_custom_snapshot_cleanup_on_signal
run_case test_returned_custom_check_descendants_are_drained
run_case test_teardown_removes_poll_artifacts
fm_case_summary "fm-pr-check-security"
