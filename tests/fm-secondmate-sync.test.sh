...
run_case test_ff_updated
run_case test_ff_current
run_case test_ff_dirty
run_case test_ff_diverged
run_case test_ff_inflight_feature_branch
run_case test_no_fetch_in_local_path
run_case test_sweep_nudge_requires_instruction_change
run_case test_bootstrap_sweep_nudges_only_instruction_change
run_case test_bootstrap_nudge_send_uses_state_override
run_case test_bootstrap_nudge_retry_rejects_malformed_marker_id
run_case test_bootstrap_nudge_failure_records_retry_marker
run_case test_bootstrap_nudge_retry_is_idempotent
run_case test_bootstrap_nudge_retry_refuses_changed_home
run_case test_nudge_retry_uses_fresh_herdr_endpoint_after_respawn
run_case test_bootstrap_sweep_surfaces_skipped_home
run_case test_spawn_fast_forwards_before_launch
run_case test_spawn_warns_when_sync_skipped_before_launch
run_case test_seed_marker_clean_when_gitignored
run_case test_seed_marker_converges_existing_home
run_case test_seed_marker_does_not_mask_real_dirt
run_case test_repo_gitignores_seed_marker
fm_case_summary "fm-secondmate-sync"
