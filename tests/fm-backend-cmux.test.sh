...
run_case test_version_check_refuses_missing_cmux
run_case test_password_reads_from_config_file
run_case test_password_preserves_config_file_whitespace
run_case test_password_respects_config_override
run_case test_password_empty_when_config_absent
run_case test_cli_exports_password_only_when_configured
...
run_case test_dispatch_routes_cmux_backend
run_case test_dispatch_busy_state_unknown_for_cmux
run_case test_dispatch_composer_state_routes_cmux
run_case test_ping_state_ok
run_case test_ping_state_denied
run_case test_ping_state_unauth
run_case test_ping_state_invalid_password
run_case test_ping_state_down
run_case test_ensure_running_returns_immediately_when_already_ok
run_case test_ensure_running_fails_fast_on_denied_without_launching
run_case test_ensure_running_fails_fast_on_unauth_without_launching
run_case test_create_task_refuses_duplicate_label
run_case test_create_task_creates_and_parses_ids
run_case test_target_ready_fails_when_target_absent
run_case test_target_ready_checks_expected_label
run_case test_target_ready_rejects_label_mismatch
run_case test_capture_trims_locally
run_case test_capture_fails_when_read_screen_fails_empty
run_case test_capture_fails_when_target_not_ready
run_case test_send_key_normalizes_and_targets
run_case test_send_key_recovers_stale_target_by_label
run_case test_send_literal_uses_separator_for_option_shaped_text
run_case test_current_path_probes_with_marker
...
run_case test_send_text_submit_send_failed_when_target_absent
run_case test_window_of_workspace_finds_window_and_count
run_case test_window_of_workspace_empty_when_not_found
run_case test_kill_closes_workspace_directly_when_not_last
run_case test_kill_adds_sibling_when_last_in_window
run_case test_kill_is_best_effort_when_close_workspace_fails
run_case test_kill_recovers_stale_target_by_label
run_case test_list_live_filters_by_title_prefix
run_case test_secondmate_spawn_refuses_cmux_backend
fm_case_summary "fm-backend-cmux"
