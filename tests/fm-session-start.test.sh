...
run_case test_context_digest_absent_empty_present
run_case test_lock_refusal_read_only_path
run_case test_output_ordering_diagnostics_lead
run_case test_herdr_backend_diagnostics_follow_real_session_start
run_case test_status_tail_bounding
run_case test_orphan_status_logs_are_printed
run_case test_endpoint_liveness_tmux
run_case test_endpoint_liveness_herdr
run_case test_composition_invokes_real_scripts
run_case test_backlog_compact_tasks_axi_omits_bodies_and_keeps_metadata
run_case test_backlog_compact_manual_backend_skips_indented_bodies
run_case test_backlog_compact_tasks_axi_unavailable_uses_manual_fallback
run_case test_fleet_digest_empty_fleet
run_case test_next_step_sources_x_mode_cadence
run_case test_next_step_afk_delegates_to_daemon
run_case test_supervision_block_exactly_one_and_pi_diagnostic
run_case test_pi_diagnostic_rejects_stale_loaded_marker
run_case test_pi_diagnostic_accepts_prelock_loaded_marker
run_case test_pi_diagnostic_rejects_missing_turnend_guard_marker
run_case test_pi_diagnostic_rejects_previous_session_loaded_marker
fm_case_summary "fm-session-start"
