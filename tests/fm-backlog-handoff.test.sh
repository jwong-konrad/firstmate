...
run_case test_body_moves_when_followed_by_another_item
run_case test_body_moves_when_followed_by_section_heading
run_case test_multi_paragraph_body_with_internal_blanks_moves_whole
run_case test_body_moves_when_last_lines_of_file
run_case test_eof_body_before_seeded_destination_section_keeps_boundary
run_case test_untouched_eof_line_preserves_terminator
run_case test_body_handoff_is_idempotent
run_case test_noncanonical_indented_continuations_refuse_without_changes
run_case test_indented_heading_is_not_section_boundary
run_case test_registry_home_with_pre_home_parentheses
run_case test_registry_home_missing_field_fails_cleanly
fm_case_summary "fm-backlog-handoff"
