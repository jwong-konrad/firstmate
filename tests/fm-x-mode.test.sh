...
run_case test_poll_no_token_is_hard_noop
run_case test_poll_empty_env_token_overrides_env_file
run_case test_poll_204_is_silent
run_case test_poll_empty_env_relay_overrides_env_file
run_case test_poll_auth_error_reports_once
run_case test_poll_error_private_publication_rejects_unsafe_paths
run_case test_poll_question_stashes_and_marks
run_case test_poll_mentions_wake_once_per_durable_offer
run_case test_poll_offer_claim_failure_reports_once
run_case test_poll_preserves_conversation_context
run_case test_poll_inbox_commit_failure_reports_error
run_case test_poll_inbox_private_publication_rejects_unsafe_paths
run_case test_poll_empty_text_is_silent
run_case test_poll_rejects_unsafe_request_id
run_case test_reply_success_posts_request_bound_only
run_case test_reply_text_file_and_stdin
run_case test_reply_non_2xx_fails
run_case test_reply_auth_header_tempfile_cleans_up_on_interrupted_post
run_case test_reply_usage_error
run_case test_reply_help_mentions_image
run_case test_reply_whitespace_text_rejected
run_case test_reply_dry_run_records_not_posts
run_case test_reply_dry_run_needs_no_token
run_case test_reply_dry_run_from_env_file
run_case test_reply_empty_env_dry_run_overrides_env_file
run_case test_reply_dry_run_fails_when_outbox_unwritable
run_case test_reply_dry_run_outbox_private_publication_rejects_unsafe_paths
run_case test_split_thread_lib
run_case test_reply_single_no_texts
run_case test_reply_thread_dry_run
run_case test_reply_discord_inbox_uses_discord_budget
run_case test_reply_x_inbox_still_uses_x_budget
run_case test_reply_inbox_explicit_limit_wins
run_case test_reply_rejects_unsafe_inbox_context_reads
run_case test_reply_max_chars_floor_clamps_to_minimum
run_case test_reply_thread_live_posts_texts
run_case test_reply_image_live_posts_image_object
run_case test_reply_image_live_streams_payload_file
run_case test_reply_image_thread_dry_run_records_compact_marker
run_case test_reply_image_dry_run_cleans_payload_temp_files
run_case test_reply_image_path_errors_are_clear
run_case test_reply_followup_live_posts_to_followup_endpoint
run_case test_reply_followup_409_marker_exits_distinctly
run_case test_reply_followup_409_without_marker_still_exits_distinctly
run_case test_reply_answer_409_is_generic_failure
run_case test_reply_followup_image_live_posts_image_object
run_case test_reply_followup_flag_position_is_flexible
run_case test_reply_followup_dry_run_marks_endpoint
run_case test_reply_followup_thread_dry_run
run_case test_reply_followup_image_dry_run_marks_endpoint_and_compacts_image
run_case test_poll_records_context_registry_from_relay_platform
run_case test_context_registry_private_publication_rejects_unsafe_paths
run_case test_context_registry_rejects_unsafe_reads
run_case test_private_artifact_publisher_runs_under_system_bash
run_case test_context_registry_prunes_expired_records
run_case test_context_registry_preserves_first_seen_timestamp
run_case test_context_registry_retention_starts_on_successful_live_answer
run_case test_regression_discord_followup_survives_inbox_cleanup
run_case test_regression_x_followup_still_splits_after_cleanup
run_case test_regression_unresolved_followup_fails_safe
run_case test_followup_partial_registry_uses_relay_budget_live
run_case test_regression_concurrent_requests_keep_own_platform
run_case test_dismiss_clears_context_registry
run_case test_dismiss_success_posts_request_only
run_case test_dismiss_dry_run_records_not_posts
run_case test_dismiss_dry_run_needs_no_token
run_case test_dismiss_dry_run_outbox_private_publication_rejects_unsafe_paths
run_case test_dismiss_non_2xx_fails
run_case test_dismiss_transport_failure_fails
run_case test_dismiss_unsafe_request_id_rejected
run_case test_dismiss_usage_error
run_case test_link_records_request_and_timestamp
run_case test_link_records_discord_platform_for_followups
run_case test_link_resolves_platform_by_request_id_after_inbox_cleanup
run_case test_link_warns_loudly_when_platform_unresolvable
run_case test_link_carry_count_and_ts_preserve_followup_binding
run_case test_link_recovery_relink_carries_discord_context_after_inbox_drain
run_case test_link_carry_count_validation
run_case test_meta_rewrites_do_not_depend_on_tmpdir
run_case test_link_rejects_unsafe_and_missing
run_case test_followup_check_states
run_case test_followup_check_expired_prunes_link
run_case test_followup_check_cap_reached_prunes_link
run_case test_followup_post_increments_counter_keeps_link
run_case test_followup_post_final_clears_link_immediately
run_case test_followup_post_cap_reached_clears_link
run_case test_followup_post_forwards_image_to_reply_client
run_case test_followup_post_failure_keeps_link
run_case test_followup_post_record_failure_clears_link
run_case test_followup_post_relay_rejection_degrades_gracefully
run_case test_followup_post_expired_skips_and_clears
run_case test_followup_post_not_linked_is_noop
run_case test_followup_post_dry_run_increments_counter_keeps_link
run_case test_followup_post_dry_run_final_clears_link
run_case test_followup_usage_errors
run_case test_bootstrap_activates_on_env_token
run_case test_bootstrap_reports_missing_x_dependency
run_case test_bootstrap_does_not_announce_when_arm_fails
run_case test_bootstrap_does_not_follow_x_artifact_symlinks
run_case test_bootstrap_inert_without_token
run_case test_bootstrap_opt_out_cleanup
run_case test_bootstrap_opt_out_reports_cleanup_failure
fm_case_summary "fm-x-mode"
