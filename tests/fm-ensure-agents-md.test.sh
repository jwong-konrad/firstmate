...
run_case test_created_agents_md_includes_self_governance
run_case test_promoted_claude_md_includes_self_governance
run_case test_promoted_claude_md_without_trailing_newline_keeps_blank_separator
run_case test_existing_agents_md_with_symlink_gains_self_governance
run_case test_existing_agents_md_without_claude_gains_section_and_symlink
run_case test_existing_agents_md_with_section_reports_unchanged
run_case test_existing_crlf_agents_md_with_section_stays_unchanged
run_case test_existing_crlf_agents_md_without_section_preserves_crlf
run_case test_lowercase_agents_md_refuses_case_fragile_symlink
fm_case_summary "fm-ensure-agents-md"
