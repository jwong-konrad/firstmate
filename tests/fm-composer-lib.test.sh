...
run_case test_bare_shell_glyphs_are_unknown
run_case test_stripped_unbordered_content_uses_plain_content
run_case test_bare_shell_prompt_with_command_is_not_empty
run_case test_bordered_shell_glyph_is_empty
run_case test_agent_glyphs_are_empty_bordered_and_bare
run_case test_empty_content_is_empty
run_case test_idle_placeholder_is_empty
run_case test_idle_placeholder_case_mode_is_explicit
run_case test_real_text_is_pending
fm_case_summary "fm-composer-lib"
