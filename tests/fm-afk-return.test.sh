...
run_case test_return_gate_orders_catchup_before_bearings
run_case test_explicit_reclassification_requires_durable_reason
run_case test_captain_decision_does_not_masquerade_as_firstmate_blocker
run_case test_away_reentry_refuses_pending_return_gate
run_case test_check_retries_recorded_terminal_teardown
fm_case_summary "fm-afk-return"
