...
run_case test_full_acceptance_matrix
run_case test_direct_policy_contract
run_case test_command_equals_form
run_case test_background_flag_accepted_and_non_gating
run_case test_unknown_flag_errors
run_case test_stdin_grok_schema_deny
run_case test_stdin_claude_codex_schema_allow
run_case test_stdin_claude_codex_schema_deny
run_case test_stdin_unrelated_command_allowed
run_case test_prefilter_is_strict_superset
run_case test_failopen_empty_stdin
run_case test_failopen_garbage_stdin
run_case test_failopen_missing_jq
run_case test_failopen_missing_node
run_case test_claude_mode_stdout_empty_on_deny
run_case test_default_mode_stdout_has_grok_json_on_deny
run_case test_allow_is_silent_both_modes
run_case test_grok_pretool_hook_wired
run_case test_grok_turnend_hook_uses_safe_var_pattern
run_case test_claude_settings_pretool_hook_wired
run_case test_codex_hooks_pretool_wired
run_case test_opencode_pretool_plugin_wired
run_case test_pi_extension_carries_pretool_check
run_case test_shellcheck_clean
fm_case_summary "fm-arm-pretool-check"
