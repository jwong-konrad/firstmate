...
run_case test_section_9_owns_positive_translation_contract
run_case test_scout_remains_allowed_house_vocabulary
run_case test_compressed_safety_labels_have_plain_renderings
run_case test_mapping_list_covers_high_risk_internal_families
run_case test_verbatim_internal_evidence_is_rejected_from_chat
run_case test_outward_facing_skill_points_reference_section_9_owner
run_case test_section_9_owner_is_not_duplicated_into_skills
fm_case_summary "fm-captain-translation-contract"
