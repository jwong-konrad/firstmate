...
run_case test_concurrent_append_and_drain
run_case test_signal_catchup_without_running_watcher
run_case test_stale_enqueue_before_suppressor
run_case test_not_working_stale_enqueue_before_suppressor
run_case test_check_output_is_queued
run_case test_atomic_double_drain
run_case test_drain_dedupes_obvious_duplicates
run_case test_drain_asserts_watcher_liveness
run_case test_structural_signal_enrichment_preserves_raw_rows
run_case test_enrichment_caps_and_status_file_failures
run_case test_slow_annotation_does_not_block_append_and_deleted_file_fails_open
run_case test_interruption_before_and_after_raw_commit
fm_case_summary "fm-wake-queue"
