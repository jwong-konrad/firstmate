...
config/app-checkouts  optional map of a project to an absolute app-source checkout outside this home, fast-forward-pulled at spawn; LOCAL, gitignored; fail-open, kill switch FM_NO_CHECKOUT_PULL=1 (section 4, docs/configuration.md). Never applies to a secondmate spawn; NOT inherited into secondmate homes
